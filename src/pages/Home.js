...
import image from "../components/assets/5e.jpg";
  ...
  return (
    <section>
      ...
      <div className="container  mx-auto py-5 md:py-12">
        <div className="rounded-bl-2xl rounded-tl-2xl  bg-gray-400  flex md:flex-row">
          <motion.div data-aos="fade-down-right" className="mx-auto w-full md:w-3/5 p-5 md:p-9 ">
            <motion.h2 className="text-blue-600 text-justify italic font-semibold text-lg  md:text">
              ~ GET INSTANT ACCESS{" "}
            </motion.h2>
            ...
            <motion.p className="text-lg py-4 w-full text-justify ">
              ...
              understanding of yourself and boost your confidence, leading to
            ...
            <div className="mt-3">
              <a
                href="/login"
                className="text-lg md:text-xl text-start items-start ring-1 leading-6 first-letter:text-blue-100 ring-white text-white bg-blue-600 py-2 px-3 rounded-xl"
              >
                Start Now
              </a>
            </div>
