        ...
        <div className="rounded-bl-2xl rounded-tl-2xl  bg-gray-400  flex md:flex-row">
          <motion.div data-aos="fade-down-right" className="mx-auto rounded-bl-2xl rounded-tl-2xl  bg-blue-600 bg-opacity-20 w-full md:w-3/5 p-5 md:p-9 ">
            ...
            <div className="mt-3">
              <a
                href="/login"
                className="hover:bg-gray-600 text-lg md:text-xl text-start items-start ring-1 leading-6 first-letter:text-blue-100 ring-white text-white bg-blue-600 py-2 px-3 rounded-xl"
              >
                Start Now
              </a>
            </div>
